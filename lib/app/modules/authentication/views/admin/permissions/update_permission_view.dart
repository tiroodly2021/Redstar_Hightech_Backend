...
class UpdatePermissionView extends GetView<PermissionController> {
  Permission? currentPermission;
  RoleController roleController = Get.put(RoleController());

  UpdatePermissionView({Key? key, this.currentPermission}) : super(key: key);

  void _editPermission(Permission permission) {
    controller.editPermission(permission);
  }
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () async {
                          Permission permission = Permission(
                              ...
                              read: controller.checkList['isRead'] ??
                                  currentPermission!.read,
                              write: controller.checkList['isWrite'] ??
