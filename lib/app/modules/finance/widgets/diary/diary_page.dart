...
import 'package:redstar_hightech_backend/app/modules/finance/widgets/diary/page_layout.dart';
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Dline(
                                title: incomeList[index].account.name,
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Dline(
                                title: expList[index].account.name,
          ...
          children: [
            Text(
              ...
              style: const TextStyle(
                  color:
                      Colors.amberAccent) /* GoogleFonts.arvo(fontSize: 13) */,
            ),
            const Spacer(),
            Text(
              trailing,
        ...
        child: Row(
          children: [
            Text(
              ...
              style: const TextStyle(
                  color: Colors
                      .amberAccent) /* GoogleFonts.arvo(fontWeight: FontWeight.bold) */,
            ),
            const Spacer(),
            Text(trailing,
                textAlign: TextAlign.end,
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Text(
        ...
        style: const TextStyle(
            color: Colors
                .amberAccent) /* GoogleFonts.orbitron(fontSize: 12, fontWeight: FontWeight.w800) */,
      ),
      const SizedBox(
        height: 10,
      ),
      ...
      Text(
        ...
        style: const TextStyle(
            color: Colors
                .amberAccent) /* GoogleFonts.averiaLibre(
